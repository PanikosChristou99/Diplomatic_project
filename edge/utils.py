...
def convert_to_jpg(first_image_path) -> str:

    if first_image_path[-4:] == '.bmp':
        img = Image2.open(first_image_path)
        first_image_path2 = first_image_path[:-4]+'.jpg'
        img.save(first_image_path2, 'JPEG')
        return first_image_path2
